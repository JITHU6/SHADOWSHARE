        ...
        ({
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    $('#image').append("<img src='/uploads/equipment/" + image + "'  name='eimage' id='image' class='img-responsive'>");
                    $('#image').append("<div id='imageup' style='display:none;'><h6>Upload photo of Item</h6><input type='file' name='itemimage' id='itemimage' class='text-center center-block file-upload'  accept='.png, .jpg, .jpeg,.JPG' onchange='readURL(this);' required></div>");
                    ...
                    $('#picka').append("<input type='text'  name='pick' id='pick' class='form-control '  value='" + pickupaddress + " ' readOnly>");
