...
<body>
    <div class="bgcolor">
        ...
        <form id="regForm" action="/sellerregaction" method=" POST" onsubmit="return " class="oh-autoval-form">
            @csrf
            <div>
                <h1>Register Here!</h1>
            </div>
            ...
            <div class="tab">
                ...
                <p><input type="text" placeholder="Full name..."  name="name" class="av-name" av-message="Enter valid username"></p>
                <p><input placeholder="Mobile number..."  name="phone" class="av-mobile" av-message="Invalid mobile number"></p>
                <p><input placeholder="E-mail..." name="email" class="av-email" av-message="Invalid  Email"></p>
                <p><input placeholder="Address line 1..."  name="add1" class="av-name" av-message="Invalid Address"></p>

                <p><input placeholder="Address lne 2..."  name="add2" class="av-name" av-message="Invalid Address"></p>
    ...
    <p><input placeholder="Password..." oninput="this.className = ''" name="pword" type="password"></p>
            ...
            <div style="overflow:auto;">
                <div style="float:right;">
                    ...
                    <button type="submit" name="sub" value="Submit" id="nextBtn" onclick="validatePassword()">Next</button>
