    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <body>
                ...
                <div class="container" style="width:80%;margin-top:05%;">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <input type="file" name="file" class="text-center file-upload"
                                        ...
                                        <div class="tab-pane active" id="home">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    ...
                                                    <input type="text" name="name" id="name" value="{{$user->name}}"
                                                        class="form-control cv-username"
                                                        cv-message="Enter valid username"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    ...
                                                    <input type="text" class="cv-username form-control"
                                                        ...
                                                        title="enter your last name if any." readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-6">
                                                    ...
                                                    <select name="panchayath" id="panchayath" class=" form-control "
                                                        readOnly>
                                                ...
                                                <div class=" row">
                                                    ...
                                                    <div class="col-xs-4 pl-4">
                                                        <input class="btn btn-lg btn-success" type="submit"
                                                            name="submit" id="update" style="display:none;"
                                                            value="update">
