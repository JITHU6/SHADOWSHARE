                ...
                <div class="container">
                    <div class="banner_content">
                        ...
                        <p>
                            ...
                            itself upon you'll dominion waters man second good you they're divided upon
                            winged were replenish night
                        </p>
                        <a class="primary_btn mr-20" href="/fstory">Request Fund</a>
                        <a class="primary_btn yellow_btn text-white" href="/needyequipment">Request Equipment</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single_causes">
                            ...
                            <p>
                                It you're. Was called you're fowl grass lesser land together waters beast
                                darkness earth land whose male all moveth fruitful.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="content_wrapper">
                                        ...
                                        <p>
                                            Be tree their face won't appear day to waters moved fourth in
                                            they're divide don't a you're were man.
                                        </p>
                                ...
                                <form target="_blank"
                                    ...
                                    <div class="input-group d-flex flex-row">
                                        <input name="EMAIL" placeholder="Your email address"
                                            ...
                                            required="" type="email">
                                        <button
                                            class="ml-10 primary_btn yellow_btn btn sub-btn rounded">SUBSCRIBE</button>
                                    </div>
                                    <div class="info"></div>
                                </form>
                            </div>
                    ...
                    <div class="row d-flex">
                        <p class="col-lg-12 footer-text text-center">
                            ...
                            document.write(new Date().getFullYear());
                                ...
                                aria-hidden="true"></i> by <a href="#" target="_blank">Shadowshare</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
