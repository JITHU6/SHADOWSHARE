...
<body class="">
    <div class="container ">
        <div class="col-12" id="myDIV" style="background-color: #00735D;">
            ...
            <form action="/savestory" method="POST" class="form-signin " id="msform" enctype="multipart/form-data">
                ...
                <div class="row " style="margin-left:25%; margin-top:10%;">
                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class=" form-group" style="Color:#ffff;width:100%;"><label>Category </label>

                            <input type="text" id="cata" name="cata" class="form-control"
                                value="{{$users->user_categoryname}}" autofocus readonly>
                            <input type="hidden" id="cataid" name="cataid" class="form-control"
                                value="{{$users->user_category}}" autofocus readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row ">
                    ...
                    <div class="card card-container col-sm-7">
                        <div>
                            ...
                            <div class="card-body">
                                <div class="pt-3">
                                    <input type="number" id="amount" name="amount" class="form-control"
                                        placeholder="enter amount" min="0" oninput="validity.valid||(value=''); "
                                        autofocus>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="pt-3">
                                    ...
                                    <input type="file" name="file" id="file" class="text-center file-upload"
                                        style="width:70%;" onchange="loadFile(event)">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        <label class="card-link " data-toggle="collapse" href="#collapse5">
                            <h5 style="color:white;">Attend the questions to make case
                                story <br>(select category from the category list)
                        </label>
                    </div>
                    ...
                    <div class="input-group-icon mt-10">
                        ...
                        <div style="margin-left:8%;margin-bottom:20%;">
                            <fieldset>
                                ...
                                <label>
                                </label></br><textarea class="form-control" name="answer{{$a}}" id=" CAT_Custom_7"
                                    rows="4"
                                ...
                                <label>Choose
                                    Option </label></br><select id="op1" class="form-control" name="answer{{$a}}"
                                    required>
...
<script src="admin/js/jquery-3.3.1.js">
</script>
...
var loadFile2 = function(event) {
    var reader = new FileReader();
    reader.onload = function() {
        var output = document.getElementById('imaa');
        output.src = reader.result;
    };
    reader.readAsDataURL(event.target.files[0]);
};
