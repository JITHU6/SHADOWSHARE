...
<div class=" col-md-12 card" style="margin-top:-7%;">
    <h5 class="project-title" itemprop="name">
        Approved Fund Requested Users</h5>
</div>
<div class="left">
                            ...
                            <div class="event-footer">
                                <div class="project-buttons">
                                    ...
                                    <a href="#" class="btn btn-yellow js-wave" itemprop="potentialAction"
                                        ...
                                        More Deatails</a><br><br>
                                    <label style="color:green;">Waiting for confirmation</label>
                                    @elseif($data->cstatus==5)
                                    <form action="/fundpayment" method="post">
                                        @csrf
                                        <input type="hidden" name="case_id" value="{{$data->case_id}}">
                                        <input type="submit" class="btn btn-danger btn-block" value="Donate">
                                        <br>
                                    </form>
                                    <label style="color:green;">User confirmed</label>
                                    @endif
...
<div class="modal fade " id="myModal" style="margin-left:20%;width:60%;">
    <div class="modal-dialog" style="width:80%;">
        ...
        <form action="/Payment" method="post" enctype="multipart/data">
            @csrf
            <div class="modal-content">
                ...
                <div class=" modal-body">
                    <div class="col-md-12">
                        ...
                        <div class=" card-image " style="margin-left:15%;" id="ccimage">

                            <!-- <input type="file" name="file" id="file" class="text-center file-upload form-control" accept=".png, .jpg, .jpeg,.JPG" style="width:70%;"
onchange=""> -->
                        </div>
                    </div><br>
...
footer -->
                <div class="modal-footer">
                    ...
                    @foreach($a as $data)
                    @if($data->cstatus==4)
                    <a href="#" class="btn btn-danger">cannot pay,user not confirmed</a>
                    @endif
                    @if($data->cstatus==5)
