                ...
                <div class="panel panel-default credit-card-box" style="padding:10px">
                    <div class="panel-heading display-table">
                        <div class="row display-tr">
                            <h3 class="panel-title display-td" align=left style="font-size:25px"><b>Payment Details</b>
                            </h3>
                    ...
                    <div class="panel-body">
                        <form role="form" id="payment-form" method="POST" action="/transaction">
                            @csrf
                            <div class="row">
                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6 col-md-6">
                                            ...
                                            <input type="hidden" name="aa" value="{{$earliest_year = 2040}}">
                                ...
                                <div class="col-xs-5 col-md-5 pull-right">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" name="cardCVV" placeholder="CVV"
                            ...
                            @isset($payment)
                            @foreach($payment as $paya)
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <div align=left class="col-xs-6"> <label
                                                style="font-size:14px">{{$paya->name}}</label>
                                        </div>
                                        <div align=right class="col-xs-6"> <label
                                                style="font-size:20px">₹{{$paya->amount}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <input type="hidden" name="price" value="{{$paya->amount}}">
                            <input type="hidden" name="user" value="{{$paya->user_id}}">
                            <input type="hidden" name="case_id" value="{{$paya->case_id}}">
                            @endforeach
                            @endisset
                            <div class="row">
                                <div class="col-xs-12">
