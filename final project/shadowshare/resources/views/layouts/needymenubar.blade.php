    ...
    <section class="fly-header parallax">
        <div class="fly-header-content">
            <div class="">
                ...
                <a class="btn btn-outline-success" href="/needyapprovedfund" id="mybutton1">Approvedfund
                    <span class="badge badge-success">{{Session::get('appovedfund')}}</span>
                </a>
                @endif
                @if (Session::has('appovedequip'))
                <a class="btn btn-outline-success" href="/equipmentapproved" id="mybutton2">Approvedequipment
                    <span class="badge badge-success">{{Session::get('appovedequip')}}</span>
                </a>
                @endif
                @if (Session::has('name'))
                <span class="fa fa-user" id="welcomename"
                    style="color:blue;">&nbsp;&nbsp;{{(Session::get('name'))}}</span>
                @endif
            </div>
