                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin-left: 10%;margin-top: 5%;">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="productname" type="text" name="question"
                                    pattern="[a-zA-Z][a-zA-Z-_?.():, ]+[a-zA-Z-_?.():,]$" required>
                            </div>
                            <div style="display:none;" id="qoption">
                                <div class="form-group">
                                    <label for="productprice" class="loginFormElement">Option 1</label>
                                    <input class="form-control" id="productprice" type="text" name="option1">
                                </div>
                                <div class="form-group">
                                    <label for="productprice" class="loginFormElement">Option 2</label>
                                    <input class="form-control" id="productprice" type="text" name="option2">
                                </div>
                                <div class="form-group">
                                    <label for="productprice" class="loginFormElement">Option 3</label>
                                    <input class="form-control" id="productprice" type="text" name="option3">
                                </div>
                                <div class="form-group">
                                    <label for="productprice" class="loginFormElement">Option 4</label>
                                    <input class="form-control" id="productprice" type="text" name="option4">
                                </div>
                      ...
                      <input class="filestyle" data-icon="false" type="file">
                            ...
                            <div>
                                <button type="submit" id="loginSubmit" class="btn btn-success loginFormElement "
                                    style="margin-top:5%;">Add Question</button>
                            </div>
                        </div>
                </form>
