            ...
            <div class="col-xs-12 col-md-7">
                ...
                <div class="panel panel-default credit-card-box" style="padding:10px">
                    ...
                    <div class="panel-body">
                        <form role="form" action="/donationpayment" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xs-12">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <div align=left class="col-xs-6"> <label
                                                style="font-size:14px">{{$data->fname}}</label>
                                        </div>
                                        <div align=right class="col-xs-6"> <label
                                                style="font-size:20px">₹{{$data->amount}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="user" value="{{$data->d_id}}">
