...
<section class="section">
    <div class="container">
        <div class="fly-events columns3 flex-container" style="margin-top:10%;">
            @isset($a)
                ...
                <article class="fly-card fly-event fly-flip-effect" id="myDIVaa" itemscope
                    ...
                    <div class="boxed flip-front">
                        ...
                        <div class="event-content">
                            <h5 class="" itemprop="">
                                <a style="color:green" href=" #">{{$data->casetitle}}</a>
                            </h5>
...
<div class="modal fadeIn " id="myModal" style="margin-left:20%;width:60%;">
    <div class="modal-dialog" style="width:80%;overflow:auto;">
        ...
        <form action="/individual" method="post" enctype="multipart/data">
            @csrf
